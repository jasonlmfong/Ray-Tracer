...
__device__ MovingSphere::MovingSphere()
{
}

__device__ MovingSphere::MovingSphere(Point3 cen0, Point3 cen1, float _time0, float _time1, float r, Material* m)
...
//__device__ bool MovingSphere::BoundingBox(float _time0, float _time1, AABB& output_box) const
//{
//    AABB box0(
...
__device__ Point3 MovingSphere::GetCenter(float time) const {
